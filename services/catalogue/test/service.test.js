  ...
  describe("getProductsByCategoryWithDiscounts", async () => {
    it("should return a JSON object with an array of products grouped by category", async () => {
      ...
      expect(result).to.deep.equal({
        ...
        "Category 2": [{ id: 3, name: "Product C" }],
      });
    });
  });
      ...
      const mockData = [
        {
          id: 1,
          code: "IMACTIVE",
          discount_name: "Deal 1 is a real and active deal",
          type: "percentage",
          value: 10,
          starts_at: new Date(now.getTime() - 10000),
          ends_at: new Date(now.getTime() + 10000),
          product_id: 1,
        ...
        },
        {
          id: 2,
          code: "IMNOTACTIVE",
          discount_name: "Deal 2 is not an active deal",
          type: "fixed",
          value: 5,
          starts_at: new Date(now.getTime() - 20000),
          ends_at: new Date(now.getTime() - 10000),
          product_id: 2,
          product_name: "Real product 2",
        },
      ];
      ...
      expect(result).to.deep.equal([
        {
          id: 1,
          code: "IMACTIVE",
          name: "Deal 1 is a real and active deal",
          type: "percentage",
          value: 10,
          products: [{ id: 1, name: "Real product" }],
        ...
        },
        {
          id: 2,
          code: "IMNOTACTIVE",
          name: "Deal 2 is not an active deal",
          type: "fixed",
          value: 5,
          products: [{ id: 2, name: "Real product 2" }],
